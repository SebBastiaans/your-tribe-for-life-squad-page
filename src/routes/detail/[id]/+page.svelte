...
<main>
  ...
  <section>
    {#if person.avatar}
      <a class="avatar" href={person.website}
        ><img class="avatar" src={person.avatar} alt="profile picture" /></a
      >
    {:else}
      <a class="avatar" href={person.website}
        ><img class="avatar" src={profilePicture} alt="profile picture" /></a
      >
    {/if}
    ...
    {#if person.github_handle}
      <a class="username" href={person.website}
        ><h2>
          {person.github_handle} <img src={kickVerified} alt="Verified" />
        </h2></a
      >
    {:else if person.nickname}
      <a class="username" href={person.website}
        ><h2>{person.nickname} <img src={kickVerified} alt="Verified" /></h2></a
      >
    {:else}
      <a class="username" href={person.website}
        ><h2>{person.name} <img src={kickVerified} alt="Verified" /></h2></a
      >
    {/if}
  ...
  <section>
    {#if person.github_handle}
      <h3>
        About {person.github_handle} <img src={kickVerified} alt="Verified" />
      </h3>
    {:else if person.nickname}
